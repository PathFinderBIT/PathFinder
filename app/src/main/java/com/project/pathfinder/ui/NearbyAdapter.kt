...
class NearbyAdapter(private val nearbyList: MutableList<ResultsItem>) :
    ...
    override fun onBindViewHolder(holder: NearbyViewHolder, position: Int) {
        ...
        val photoReference = currentItem.photos?.get(0)?.photoReference
        ...
        if(currentItem.openingHours?.openNow == true) {
